...
public class Game
    ...
    public void create() {
        ...
        // This is a bad implementation, but this is where we add the player
        IGamePluginService playerPlugin = new PlayerPlugin();
        IEntityProcessingService playerProcess = new PlayerControlSystem();
        entityPlugins.add(playerPlugin);
        entityProcessors.add(playerProcess);
        
        // Now we add the enemy
        ...
        IGamePluginService CollisionPlugin = new CollisionPlugin();
        IEntityProcessingService CollisionProcess = new CollisionControlSystem();
